...
## 本项目获取地址：https://www.bishecode.com/product/174/
...
在分析并得出使用者对程序的功能要求时，就可以进行程序设计了。如图展示的就是管理员功能结构图，管理员在后台主要管理电影管理,论坛管理,公告信息管理等。
...
图5.1 电影列表页面【如图5.1显示的就是电影列表页面，此页面提供给管理员的功能有：查看电影、新增电影、修改电影、删除电影等。】
